...
<body>
	...
	<div role="tabpanel">
		...
		<ul class="nav nav-tabs" role="tablist">
			<li role="presentation" class="active"><a href="#list" aria-controls="list" role="tab" data-toggle="tab">현재 발주 내역</a></li>
			<li role="presentation"><a href="#success" aria-controls="success" role="tab" data-toggle="tab">완료된 내역</a></li>
		</ul>
		<!-- Tab panes -->
		<div class="tab-content">
			<div role="tabpanel" class="tab-pane fade in active" id="list">
				<div class="container">
					<div class="row">
						<table width="100%" class="table table-hover background-white" id="dataTables-example">
							<thead>
								<tr>
									<th>물품 내용</th>
									<th>요청 개수 / 남은개수</th>
							...
							<c:if test="${var.order_check != 'yes' ||  var.order_delivery != 'yes'}">
