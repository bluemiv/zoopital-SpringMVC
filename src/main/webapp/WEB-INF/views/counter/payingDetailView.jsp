				...
				<form id="frm" name="frm" method = "post">
					...
					<div class="row">
						<div class="form-group col-xs-12">
							<input class = "btn btn-custom btn-md" type="button" onclick = "end_sub()" value="수납완료">
							<input class = "btn btn-custom btn-md" type="button" onclick = "location='payingList.pet'" value="돌아가기">
						</div>
					</div>
				</form>
			</div>
